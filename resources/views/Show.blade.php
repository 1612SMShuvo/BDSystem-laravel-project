...
<body>
    ...
    <table border="4" cellspacing="10" cellpadding="0" style="color: white">
        <thead>
            <tr>
                <th>Serial No.</th>
                <th>Name</th>
  ...
  @foreach($Showdata as $v_dat)
    <tr>
      ...
      <td><a href="{{URL::to('/Profileedit/'.$v_dat->id)}}"><button>Edit</button></a></td>
    </tr>
  @endforeach
  </tbody>
</table><br><br><br></br>

      <a href="{{url('/Admin')}}"><button>Logout</button></a><br></br>
</div>
</body>
@endsection